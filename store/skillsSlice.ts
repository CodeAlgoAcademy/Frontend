...
const NEW_YORK_ONE = [
	{ categoryId: "K-1.CT.6", categoryTitle: "Follow an algorithm to complete a task.", tests: [{ testId: "", testTitle: "test1" }] },
	{
		categoryId: "K-1.CT.8",
...
const NEW_YORK_TWO = [
	{ categoryId: "2-3.CT.6", categoryTitle: "Create two or more algorithms for the same task.", tests: [{ testId: "", testTitle: "test1" }] },
	{
		categoryId: "2-3.CT.8",
