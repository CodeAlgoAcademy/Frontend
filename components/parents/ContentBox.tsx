...
const ContentBox = ({children,title,showSublink,padding,size,link}: Props) => {
   return (
      <div className='self-center overflow-y-clip overflow-x-auto sm:overflow-x-hidden short-scroll-thumb relative' style={{width: size === "large" ? "100%" : "auto",}}>
         <div className='rounded-2xl relative py-6 bg-white h-[340px]' style={{paddingLeft: padding === "small" ? "24px" : "44px",paddingRight: padding === "small" ? "24px" : "44px",width: size === "large" ? "100%" : "416px",minWidth: "416px"}}>
