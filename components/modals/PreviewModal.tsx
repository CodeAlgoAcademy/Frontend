...
export default function PreviewModal(props:modalProps) {
  ...
  return (
    ...
    {props.showPreview && (<motion.div 
        ...
        exit="hidden"
    >
        <motion.div  variants={modal} className=' bg-white mt-[4rem] w-[50rem] mx-auto px-12 pt-6 pb-10 rounded-[10px] flex'>
           <div className='flex-1 pr-8 mt-10'>
                ...
                <button className="px-7 py-2 rounded-full font-bold text-[#412281] border border-[#412281] mt-10">View quiz</button>
            </div> 

            <div className='flex-1 pl-10 border-l border-[#D1D1D1]'>
                <div className='cursor-pointer' onClick={(event) => props.cancelPreview(event)}><GiCancel className='text-[2rem] ml-auto'/></div>
                <h1 className='text-xl font-bold text-black mt-8'>
                    Lesson Description
                </h1>
                <Image src={preview1} objectFit="cover" width={250} height={150}  quality={100}/>
                <h1 className='text-xl font-bold text-black mt-10'>
                    Lesson Description
                </h1>
                <Image src={preview2} objectFit="cover" width={250} height={150}  quality={100}/>
            </div>
