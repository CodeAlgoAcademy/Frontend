      ...
      <div className={styles.modalOverlay}>
         <form className={styles.modal} onSubmit={submit}>
            <header className="mb-6 flex items-center justify-between gap-3">
               <p className="cursor-pointer text-[1.2rem] font-bold text-orange-400">Resend Email</p>
            ...
            <div>
               <div className="mx-auto mb-8 flex h-[64px] max-w-[400px] flex-col items-center justify-center text-center text-[1rem]  text-gray-900">
                  ...
                  <input
                     className="w-full max-w-[300px] rounded-md border-[1.5px] border-orange-400 p-2 font-medium outline-none placeholder:font-medium"
