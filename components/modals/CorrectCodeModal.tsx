      ...
      <main className={styles.modalOverlay}>
         <div className={styles.modal}>
            <header className="mb-6 flex items-center justify-between gap-3">
               <p className="cursor-pointer text-[1.2rem] font-bold text-orange-400">Congratulations</p>
               <i
...
const styles = {
   ...
   button: "bg-orange-400 text-white py-3 px-2 rounded-md max-w-[300px]  w-full text-center",
};
