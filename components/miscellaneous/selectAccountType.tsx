...
export default function SelectAccountType() {
   ...
   return (
      <div className="">
         <div className="px-[1rem] pt-[1rem]  text-[1.8rem] text-mainPink md:absolute md:top-[2.4rem] md:left-[2rem] md:px-0 md:py-0">
            <Link href={"/"}>
               <BiHome className="cursor-pointer" />
            </Link>
         </div>

         <h1 className="mt-[2rem] text-center text-xl font-bold text-mainPink md:mt-[2rem] md:text-3xl">
         ...
         <div className="mx-6 mt-[2rem] grid flex-col items-center justify-center gap-y-6 sm:grid-cols-2 md:mt-[7rem] md:grid-cols-3 md:flex-row md:gap-x-[5rem] lg:grid-cols-4">
            <Link href={slug.pathname.includes("/signup") ? "/signup/organizer" : "/login/organizer"}>
               <div className="transition duration-300 ease-out hover:scale-110 hover:text-mainPink">
