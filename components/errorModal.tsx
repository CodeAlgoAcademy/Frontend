...
const ErrorModal = () => {
  const { errorModalOpen, errorText } = useSelector(
  ...
  return (
    <div className="fixed top-0 left-0 z-[70] w-[100vw] min-h-screen flex justify-center items-center bg-[rgba(0,0,0,0.5)]">
      {/* modal */}
      <div className="w-[90vw] max-w-[450px] bg-white shadow-md rounded-md mx-auto rounded-md overflow-hidden">
        ...
        <div className="bg-white p-4">
          {/* display errors */}
          <h3 className="mb-6 text-[18px] font-semibold">{errorText}</h3>
