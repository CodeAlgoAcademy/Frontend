  ...
  return (
    <div key={8}>
      ...
      <p className="font-[400] text-[14px]">
        ...
        or username of your student’s friends below. A request will be sent to the linked parent
        account. They can then accept or decline the request.
      </p>
      ...
      <input
        ...
        required
      />
      <p className="text-[14px] mt-4 text-center font-semibold">
        You can update or add to this list at any time in your settings
      </p>
    </div>
  );
}
