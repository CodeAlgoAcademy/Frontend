...
export default function ParentSignUp5() {
  return (
    <div key={5}>
      ...
      <input className='block w-full h-[2.5rem] rounded-xl px-4 py-2 focus:outline-0 mt-3' type="email" autoFocus required/>
      ...
      <input className='block w-full h-[2.5rem] rounded-xl px-4 py-2 focus:outline-0 mb-[2.5rem] mt-3' type="password" required/>
    </div>
  );
}
