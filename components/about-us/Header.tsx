               ...
               <div className="flex-1">
                  <Fade triggerOnce={true} direction={"up"} duration={1000}>
                     <h1 className="font-tiltWarp text-[3.5rem] font-bold leading-[1.1] text-slate-700 md:max-w-[500px]">
                        About{" "}
                        <span className="bg-gradient-to-r from-pink-500 via-mainRed to-pink-600 bg-clip-text font-extrabold text-transparent">
                           CodeAlgo Academy
                        </span>
                     </h1>
                  </Fade>
                  ...
                  <Fade triggerOnce={true} direction="up" duration={1000} delay={400}>
                     <Link href={"/login"}>
                        <button className="mt-8 min-w-[120px] rounded-lg bg-mainRedp-3 font-tiltWarp text-[15px] font-bold text-white shadow-md">
                           Sign in
                        </button>
                     </Link>
                  </Fade>
