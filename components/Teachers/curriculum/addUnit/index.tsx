...
export const availableUnits = [
   ...
   },
   {
      ...
      endDate: "",
      isChosen: false,
      hoverText: "Variables are used to stored to be referenced and manipulated in a computer program",
   },
   {
      id: "4",
      title: "Conditionals",
      ...
      endDate: "",
      isChosen: false,
      hoverText: "Conditionals are ways for computers to make decisions based on an action being true or false",
   },
   {
      id: "5",
      title: "Loops",
      ...
      endDate: "",
      isChosen: false,
      hoverText: "Loop is a sequence of instructions that is continually repeated until a certain condition is reached. ",
   },
   {
      id: "6",
      title: "Modularity",
      ...
      endDate: "",
      isChosen: false,
      hoverText: "Modular programming is the process of subdividing a computer program into separate sub-programs",
   },
   {
      id: "7",
   ...
   },
   {
      ...
      endDate: "",
      isChosen: false,
      hoverText: "File I/O i.e file input/output refers to operations such as open, close, read and write",
   },
   {
      id: "14",
...
function AddUnit() {
   ...
   return (
      <section
         className="close-dropdown relative mx-auto min-h-screen w-full max-w-[1200px] flex-1 rounded-md bg-gray-100 px-8 py-16"
         onClick={(event: any) => {
            if (event.target.classList.contains("close-dropdown")) {
               updateOpenedModal("");
            }
         }}
         data-testid="add-unit-modal"
      >
         <i
            className="absolute top-[15px] right-[15px] cursor-pointer text-[28px] font-bold text-red-600"
            onClick={() => {
         ...
         <div className="mt-8 flex w-full flex-row flex-wrap items-center justify-center gap-x-4 gap-y-2">
            <button
