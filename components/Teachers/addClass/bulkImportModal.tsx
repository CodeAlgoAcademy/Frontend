...
const BulkImportModal = ({ setBulkImportModalOpen }: { setBulkImportModalOpen: Dispatch<SetStateAction<boolean>> }) => {
   ...
   return (
    <section className="fixed inset-0 z-[999] overflow-y-auto bg-black/60 backdrop-blur-sm">
         <div className="flex min-h-full items-center justify-center p-4 py-8">
            <main className="relative w-full max-w-[850px] max-h-[70vh] overflow-y-auto rounded-xl bg-white p-6 shadow-2xl">
