      ...
      <div className={styles.chatContainer}>
        {[...messages]
          ...
          ?.map((chat,index) => (
            <div key={index}>
              <p
                className={`${styles.chats} ${chat.user.email === email ? 'ml-auto rounded-bl-lg' : 'rounded-br-lg'
                  }`}
              >
                {chat.text}
              </p>
...
const styles = {
  header: 'flex items-center space-x-2 border-b-2 py-3 px-5',
  ...
  inputContainer: 'flex items-center space-x-2 px-5 py-3 border-t text-slate-400',
