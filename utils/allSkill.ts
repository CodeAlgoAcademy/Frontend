...
export const CTSA_TWO = [
   ...
   {
      categoryId: "1B-AP-09",
      categoryTitle: " Create programs that use variables to store and modify data.",
...
export const KANSAS_ONE = [
   ...
   },
   {
      ...
      categoryTitle: "Independently or collaboratively export construct, execute, and debug (identify and fix) algorithms ",
...
export const KANSAS_TWO = [
   ...
   },
   {
      ...
      categoryTitle: "Independently, or collaboratively export construct algorithms (sets of step-by-step instructions) to accomplish tasks",
   ...
   },
   {
      ...
      categoryTitle:
         "With guidance, independently, or collaboratively export construct, execute, and debug (identify and fix) programs using a programming language and/or unplugged activity that includes sequencing and repetition.",
...
export const KANSAS_THREE = [
   ...
   },
   {
      ...
      categoryTitle: "Independently and collaboratively export construct, execute, analyze and debug (fix) an algorithm using a programming language",
