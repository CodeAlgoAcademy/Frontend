...
export default function Parent() {
  ...
  return (
    <div className='bg-gradient-to-br from-[#78A8FB] to-[#C4D7F8] min-h-[100dvh] p-[2rem] relative'>
            ...
            <div className='bg-white mr-[-2rem] w-[600px] px-[5rem] py-[4rem] bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-20 rounded-[2.5rem]'>
                <form>
                    ...
                    <div>
                        ...
                        {(!isFirstStep && !isLastStep) && <button className='block text-center w-full mt-4 capitalize' type="button" onClick={back}>back</button>}
