...
const styles = {
    container: 'bg-gray-200 h-full px-5 md:px-20 py-5 overflow-x-auto sm:ml-[20rem]',
    containerHeader: 'flex justify-between py-3 items-center border-b border-b-slate-400',
    headerTitle: 'font-medium text-[30px]',
    addDiv: 'flex items-center space-x-2 font-light cursor-pointer hover:bg-slate-100 p-3 transition-all duration-300',
