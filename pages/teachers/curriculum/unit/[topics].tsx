      ...
      <div className="flex justify-start items-center gap-6">
        ...
        <div className="flex justify-between sm:items-center flex-1 gap-2 sm:flex-row flex-col">
          ...
          <div className="flex items-center gap-x-2">
            <div
              className="flex gap-2 text-[#2073fa] items-center cursor-pointer px-2 py-3 hover:bg-gray-50 rounded-lg"
              onClick={() => {
            ...
            <Link href="/teachers/curriculum/assignments">
              <div className="flex gap-2 items-center cursor-pointer px-2 py-3 hover:bg-gray-50 text-[#2073fa] rounded-lg">
                <IoIosAddCircleOutline className="text-4xl " />
