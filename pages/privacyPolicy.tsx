    ...
    <section className="w-full max-w-[1200px] mx-auto px-6 py-12 min-h-screen">
      ...
      <div className="mt-[20px]">
        ...
        <p className="mt-[15px] text-[15px]">
          By using our software, or by clicking on a box that states you agree to these terms, you
      ...
      <div className="mt-[20px]">
        <h1 className="text-orange-600 text-[23px] font-bold">Privacy</h1>
        <p className="mt-[15px] text-[15px]">
          At CodeAlgo, we take your privacy seriously. Please read this Non-Student User Privacy
      ...
      <div className="mt-[20px]">
        <h1 className="text-orange-600 text-[23px] font-bold">Usage Requirements</h1>
        <p className="mt-[15px] text-[15px]">
          n order to use CodeAlgo, you must have: • an account; • a browser device, or mobile device
